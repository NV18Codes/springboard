        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {services.map((service, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-8 hover:shadow-strong transition-all duration-300 border-l-4 border-l-accent"
              >
                <div className="flex items-start gap-4 mb-6">
                  <div className="p-3 bg-gradient-primary rounded-lg">
                    <Icon className="h-8 w-8 text-primary-foreground" />
                  </div>
                  <h3 className="text-2xl font-bold text-foreground flex-1 pt-2">
                    {service.title}
                  </h3>
                </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12">
          {securityServices.map((service, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-8 bg-gradient-primary hover:shadow-strong transition-all duration-300"
              >
                <div className="flex items-start gap-4 mb-4">
                  <div className="p-3 bg-accent/20 rounded-lg">
                    <Icon className="h-8 w-8 text-primary-foreground" />
                  </div>
                  <h3 className="text-2xl font-bold text-primary-foreground flex-1 pt-2">
                    {service.title}
                  </h3>
                </div>
