        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {reasons.map((reason, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-6 hover:shadow-medium transition-all duration-300 group"
              >
                <div className="mb-4">
        ...
        <Card className="p-8 md:p-12 bg-gradient-hero shadow-strong">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-3xl mx-auto">
              Instead of managing vendors, you manage growth. Leveraging strong distributor ties
              for rapid procurement and deployment without compromising on quality or timelines.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <div className="px-6 py-3 bg-card/20 backdrop-blur-sm rounded-lg border border-primary-foreground/20">
                <span className="text-primary-foreground font-semibold">10+ Years Experience</span>
              </div>
              <div className="px-6 py-3 bg-card/20 backdrop-blur-sm rounded-lg border border-primary-foreground/20">
                <span className="text-primary-foreground font-semibold">50+ Enterprise Clients</span>
              </div>
              <div className="px-6 py-3 bg-card/20 backdrop-blur-sm rounded-lg border border-primary-foreground/20">
                <span className="text-primary-foreground font-semibold">Local UAE Presence</span>
              </div>
            </div>
          </div>
        </Card>
